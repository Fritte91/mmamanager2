...
const cycleStartDate = new Date("2024-12-16"); // Start of the cycle based on Discipline Event

const events = [
    {
        name: "Tournament",
        startDate: new Date(cycleStartDate.getTime() + (1 - 1) * 24 * 60 * 60 * 1000).toISOString().split('T')[0], // Day 1
        duration: 7,
        cycleLength: 28,
    ...
    },
    {
        ...
        startDate: new Date(cycleStartDate.getTime() + (5 - 1) * 24 * 60 * 60 * 1000).toISOString().split('T')[0], // Day 5
        duration: 2,
        cycleLength: 28,
        specificDays: [5, 6],
    ...
    },
    {
        ...
        startDate: new Date(cycleStartDate.getTime() + (11 - 1) * 24 * 60 * 60 * 1000).toISOString().split('T')[0], // Day 11
        duration: 2,
        cycleLength: 28,
        specificDays: [11, 12],
    ...
    },
    {
        ...
        startDate: new Date(cycleStartDate.getTime() + (12 - 1) * 24 * 60 * 60 * 1000).toISOString().split('T')[0], // Day 12
        duration: 2,
        cycleLength: 28,
        specificDays: [12, 13],
    ...
    {
        name: "Training Event",
        startDate: new Date(cycleStartDate.getTime() + (20 - 1) * 24 * 60 * 60 * 1000).toISOString().split('T')[0], // Day 20
        duration: 2,
        cycleLength: 28,
        specificDays: [20, 21],
    ...
    },
    {
        ...
        startDate: new Date(cycleStartDate.getTime() + (27 - 1) * 24 * 60 * 60 * 1000).toISOString().split('T')[0], // Day 27
        duration: 1,
        cycleLength: 28,
        specificDays: [27],
    ...
    },
    {
        ...
        startDate: new Date(cycleStartDate.getTime() + (8 - 1) * 24 * 60 * 60 * 1000).toISOString().split('T')[0], // Day 8
        duration: 7,
        cycleLength: 28,
    ...
    },
    {
        ...
        startDate: new Date(cycleStartDate.getTime() + (22 - 1) * 24 * 60 * 60 * 1000).toISOString().split('T')[0], // Day 22
        duration: 7,
        cycleLength: 28,
...
const startDate = new Date("2024-12-16"); // Start on the Monday of the week containing January 11
